    ...
    <div className="relative bg-gray-100 min-h-screen">
      ...
      >
        ...
        <div className="mt-8 flex flex-col md:flex-row items-center justify-center w-full max-w-3xl">
          <div className="relative flex flex-col md:flex-row items-center justify-center border-4 rounded-3xl border-green-700 p-4 bg-yellow-200 mb-4 md:mb-0 md:mr-4">
            <h2 className="absolute -top-9 text-green-700 font-body text-xl font-bold">Choose trees quantity</h2>
            <div className="flex flex-col items-center md:flex-row">
              <img src="/tree1.png" alt="Tree" className="w-24 h-18 mb-4 md:mb-0 md:mr-4" />
              <input
                type="number"
                id="treeCount"
                value={treeCount}
                onChange={handleTreeCountChange}
                className="bg-white text-green-800 font-body py-2 px-4 rounded border-2 border-green-800 shadow-md mb-4 md:mb-0"
                min="1"
              />
            </div>
          </div>
          <div className="flex flex-col items-center w-full md:w-auto">
            <button
              ...
              className="bg-green-700 hover:bg-green-800 text-yellow-200 font-bold py-2 px-4 rounded w-40 mb-4 md:mb-0 md:mr-4"
            >
              Plant!
            </button>
            <button
