  ...
  return (
    <div className="relative bg-gray-100 flex flex-col min-h-screen overflow-auto">
      ...
      <main className="relative flex flex-col items-center justify-center md:pt-0 pt-0">
        ...
        <div className="my-4 flex flex-col items-center w-full max-w-xl px-2">
          <div className="flex items-center justify-center w-full mb-4">
            <div className="flex flex-wrap items-center justify-center gap-2">
              ...
              <input
                ...
                className="bg-transparent border-2 border-green-700 text-green-700 font-bold py-2 px-2 rounded focus:outline-none focus:ring-2 focus:ring-green-500 flex-grow min-w-[80px] max-w-[150px]"
              />
              <button
