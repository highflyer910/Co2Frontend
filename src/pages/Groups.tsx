      ...
      <main className="relative flex flex-col items-center justify-center md:pt-0 pt-0">
        ...
        <div className="my-4 flex flex-col items-center w-full max-w-md px-4">
          <div className="flex items-center w-full mb-2 relative">
            <img src="/tree.png" alt="Tree" className="absolute left-0 w-8 h-8 ml-2" />
            <select
              onChange={handleDropdownChange}
              className="flex-grow pl-10 bg-transparent border-2 border-green-700 text-green-700 font-bold py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-green-500"
            >
